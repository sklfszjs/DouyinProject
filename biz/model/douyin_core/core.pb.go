...
type Comment struct {
	...
	CreatedDate string `protobuf:"bytes,4,req,name=created_date" json:"created_date,required" form:"created_date,required" query:"created_date,required"`   
...
type User struct {
	...
	FollowCount   int64   `protobuf:"varint,3,req,name=follow_count" json:"follow_count,required" form:"follow_count,required" query:"follow_count,required"`                            // 关注总数
	FollowerCount int64  `protobuf:"varint,4,req,name=follower_count" json:"follower_count,required" form:"follower_count,required" query:"follower_count,required"`                       // 粉丝总数
